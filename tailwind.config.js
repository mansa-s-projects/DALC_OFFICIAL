  ...
  theme: {
    extend: {
      colors: {
        ...
        // ── DALC DESIGN SYSTEM ─────────────────────────────────────────────
        // Warm black / rich gold / beige — Dubai À La Carte
        cipher: {
          // Backgrounds — warm brown-blacks, not blue-tinted
          void:    '#080706',
          ink:     '#0D0B08',
          deep:    '#120F0A',
          surface: '#181510',
          ...
          // Gold — richer, warmer than CIPHER
          gold:          '#C9A84C',
          'gold-bright': '#E8CC70',
          'gold-mid':    '#A88535',
          'gold-dim':    '#7A6025',
          ...
          // Beige — the third DALC tone
          beige:         '#F5EDD8',
          'beige-mid':   '#D4C9A8',
          'beige-dim':   '#8A7D60',
          'beige-trace': '#2A2518',

          // Borders — beige-tinted rims (parchment feel, not cold white)
          rim:  'rgba(212,195,150,0.07)',
          rim2: 'rgba(212,195,150,0.12)',
          rim3: 'rgba(212,195,150,0.22)',

          // Text — warm beige-cream, not cold white
