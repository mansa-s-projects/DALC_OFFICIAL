...
export default function CarCard({ car, categoryId }: CarCardProps) {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col flex-1 p-5">
        ...
        {/* CTA */}
        <a
          href={getCarWhatsAppUrl(car.brand, car.model, car.year)}
          target="_blank"
          rel="noopener noreferrer"
          className="mt-auto w-full py-2.5 bg-white/10 hover:bg-[#25D366] border border-white/15 hover:border-[#25D366] text-white uppercase text-[9px] font-bold tracking-[0.2em] transition-all duration-300 flex items-center justify-center gap-2 rounded-lg"
        >
