...
import { useFeaturedExperiences, useUpcomingEvents } from '../../features/experiences/hooks/useExperiences';
import type { ExperienceSubcategory } from '../../features/experiences/types';
import {
  SUBCATEGORY_LABELS,
      ...
      <section id="categories" className="px-4 md:px-8 max-w-7xl mx-auto py-24">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
          {CATEGORIES.map((cat, idx) => (
            ...
            >
              <Link
                href={`/experiences/${cat.subcategory}`}
          ...
          {eventsLoading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {upcomingEvents.map((event, idx) => (
                ...
                >
                  <Link
                    href={`/experiences/${event.subcategory}/${event.slug}`}
