        ...
        <div className="glass-panel p-8 md:p-12 rounded-xl border border-white/10 relative overflow-hidden">
          ...
          {step === 3 && (
            ...
            >
              ...
              <button onClick={() => router.push('/explore')} className="px-8 py-3 border border-white/20 text-white font-bold uppercase tracking-widest hover:bg-white/5 transition-colors">
                Return to Explore
              </button>
            </motion.div>
          )}
