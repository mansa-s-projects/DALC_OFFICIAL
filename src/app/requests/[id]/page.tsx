...
export default function RequestDetailPage() {
  ...
  // In Next.js App Router, we get initial request from the query data
  // The state passing pattern from Link is handled differently - we'll rely on the query
  const initialRequest: Request | null = null;
    ...
    <div className="min-h-screen bg-luxury-black">
      ...
      <div className="pt-32 pb-20 px-4 max-w-5xl mx-auto">
        <div className="mb-10 flex items-center gap-3 text-sm">
          <Link href="/my-requests" className="text-gray-500 hover:text-luxury-gold transition-colors inline-flex items-center gap-2">
