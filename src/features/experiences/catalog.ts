...
function getObservationItems(): ExperienceCatalogItem[] {
  return [
    ...
    },
    {
      ...
      description: 'Heart-shaped desert lake visible from the air â a romantic desert landscape unique to Dubai  Oct–Apr',
    ...
    },
    {
      slug: 'hatta-dam',
      title: 'Hatta Dam',
      description: 'Turquoise mountain reservoir surrounded by the Hajar mountains â popular for kayaking  Oct–Apr',
    ...
    },
    {
      ...
      description: 'Wildlife island reserve with Arabian oryx, cheetahs & giraffes â a rare UAE safari experience  Oct–Apr',
    ...
    },
    {
      ...
      description: 'Hidden coastal mangrove reserve with flamingos and rare birdlife near Ajman city  Hidden Gem ð®  Oct–Apr',
      image: 'https://images.unsplash.com/photo-1518822374967-36b15e5f36f5?q=80&w=800&auto=format&fit=crop',
      ctaLabel: 'Discover',
    },
  ];
...
function getWaterExtrasItems(): ExperienceCatalogItem[] {
  ...
  return [
    ...
    },
    {
      ...
      description: 'Small island famous for crystal waters, coral reefs, and sea turtles â snorkeling paradise  Oct–May',
      image: divingImg,
      ctaLabel: 'Discover',
    },
    {
...
function getCulturalItems(): ExperienceCatalogItem[] {
  ...
  return [
    ...
    },
    {
      ...
      description: 'Best preserved neighborhood in Dubai â traditional wind towers, the Dubai Museum, art galleries  Free  Oct–Apr',
      image: cultureImg,
      ctaLabel: 'Discover',
    },
    {
    ...
    },
    {
      ...
      description: 'The only remaining hilltop fort in the UAE â sweeping views over palm groves  Hidden Gem ð®  Oct–Apr',
      image: cultureImg,
      ctaLabel: 'Discover',
    },
    {
    ...
    },
    {
      ...
      description: 'Ancient marine fossils embedded in sandstone formations â prehistoric UAE in the desert  Oct–Apr',
    ...
    },
    {
      ...
      description: 'Ancient human settlements in Arabia â fossils, desert expeditions and Bronze Age tombs  Oct–Apr',
      image: cultureImg,
      ctaLabel: 'Plan Visit',
    },
    {
...
function getYachtCharterItems(): ExperienceCatalogItem[] {
  const yachtImg = 'https://images.unsplash.com/photo-1567899378494-47b22a2ae96a?q=80&w=800&auto=format&fit=crop';
  const largeYachtImg = 'https://images.unsplash.com/photo-1605281317010-fe5ffe798166?q=80&w=800&auto=format&fit=crop';
  return [
    {
      slug: 'luxury-yacht',
      title: 'Luxury Yacht Charter',
      description: 'Premium yacht rental from 55ft to 120ft — up to 35 guests — from AED 950/hour. Sunseeker, Azimut, San Lorenzo and more.',
      image: yachtImg,
      ctaLabel: 'Request Charter',
    },
    {
      slug: 'party-yacht',
      title: 'Party Yacht Dubai',
      description: 'Large capacity yachts from 80ft — perfect for celebrations, corporate events and group gatherings — up to 40 guests.',
      image: largeYachtImg,
      ctaLabel: 'Plan My Event',
    },
    {
      slug: 'fishing-yacht',
      title: 'Fishing Yacht Charter',
      description: 'Deep sea fishing expeditions from Dubai Marina — half-day and full-day charters with experienced crew and gear included.',
      image: 'https://images.unsplash.com/photo-1544551763-46a013bb70d5?q=80&w=800&auto=format&fit=crop',
      ctaLabel: 'Book Trip',
    },
    {
      ...
      description: 'Intimate 2-hour sunset cruise from Dubai Marina — skyline views, refreshments and the golden hour on the Arabian Gulf.',
      image: 'https://images.unsplash.com/photo-1512632578888-169bbbc64f33?q=80&w=800&auto=format&fit=crop',
      ctaLabel: 'Book Cruise',
    },
  ];
...
function getEntertainmentItems(): ExperienceCatalogItem[] {
  return [
    {
      slug: 'aquaventure-waterpark',
      title: 'Aquaventure Waterpark',
      description: 'Atlantis The Palm\'s iconic waterpark — 105 rides and slides, private beach, and the legendary Leap of Faith — from AED 355/adult.',
      image: 'https://images.unsplash.com/photo-1530870110042-98b2cb110834?q=80&w=800&auto=format&fit=crop',
      ctaLabel: 'Book Tickets',
    },
    {
      ...
      description: 'The world\'s largest indoor theme park — Marvel, Cartoon Network, IMG Boulevard and more — from AED 395/person.',
      image: 'https://images.unsplash.com/photo-1612287753685-a3e1c3ac3dd5?q=80&w=800&auto=format&fit=crop',
      ctaLabel: 'Book Tickets',
    },
    {
      slug: 'museum-of-the-future',
      title: 'Museum of the Future',
      description: 'Dubai\'s most iconic landmark — an immersive experience of tomorrow\'s world. Daily guided and self-guided visits from AED 149.',
      image: 'https://images.unsplash.com/photo-1518684079-3c830dcef090?q=80&w=800&auto=format&fit=crop',
      ctaLabel: 'Book Visit',
    },
    {
      ...
      description: 'Seasonal multicultural festival park — 90+ countries, live performances, street food and rides — from AED 25/entry (Oct–Apr).',
    ...
    },
    {
      slug: 'dubai-frame',
      title: 'Dubai Frame',
      description: 'Step inside the 150m golden frame connecting old and new Dubai — glass bridge, stunning skyline views — from AED 50.',
      image: 'https://images.unsplash.com/photo-1512453979798-5ea266f8880c?q=80&w=800&auto=format&fit=crop',
      ctaLabel: 'Book Tickets',
    },
    {
      ...
      description: 'The world\'s tallest building at 828m — Level 124 & 125 observation decks, or Level 148 SKY for the ultimate view — from AED 149.',
      image: 'https://images.unsplash.com/photo-1518684079-3c830dcef090?q=80&w=800&auto=format&fit=crop',
      ctaLabel: 'Book Now',
    },
  ];
...
function getAbuDhabiToursItems(): ExperienceCatalogItem[] {
  const abuDhabiImg = 'https://images.unsplash.com/photo-1513475382585-d06e58bcb0e0?q=80&w=800&auto=format&fit=crop';
  return [
    {
      slug: 'sheikh-zayed-grand-mosque',
      title: 'Sheikh Zayed Grand Mosque Tour',
      description: 'Private guided visit to the world\'s 8th largest mosque — Lexus transfer from Dubai — from AED 990/car.',
      image: abuDhabiImg,
      ctaLabel: 'Book Tour',
    },
    {
      ...
      description: 'The world\'s largest indoor theme park, home to Formula Rossa — the world\'s fastest roller coaster — from AED 295/child, AED 350/adult.',
    ...
    },
    {
      ...
      description: 'Six immersive worlds featuring Batman, Superman, Bugs Bunny and more — the ultimate family theme park — from AED 295/person.',
      image: 'https://images.unsplash.com/photo-1612287753685-a3e1c3ac3dd5?q=80&w=800&auto=format&fit=crop',
      ctaLabel: 'Book Tickets',
    },
    {
      ...
      description: 'Private chauffeur-driven city tour — Grand Mosque, Corniche, Qasr Al Watan, Emirates Palace — from AED 1,290/car.',
      image: abuDhabiImg,
      ctaLabel: 'Book Tour',
    },
    {
      ...
      description: 'Jean Nouvel\'s architectural masterpiece on Saadiyat Island — world-class art collection with a unique cultural narrative — from AED 63/adult.',
      image: abuDhabiImg,
      ctaLabel: 'Plan Visit',
    },
  ];
...
function getOmanToursItems(): ExperienceCatalogItem[] {
  const omanImg = 'https://images.unsplash.com/photo-1519681393784-d120267933ba?q=80&w=800&auto=format&fit=crop';
  return [
    {
      slug: 'musandam-cruise',
      title: 'Musandam Fjord Cruise',
      description: 'Day trip to Oman\'s stunning Musandam fjords — dolphin watching, snorkelling, cave visit and lunch — from AED 450/adult.',
      image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=800&auto=format&fit=crop',
      ctaLabel: 'Book Day Trip',
    },
    {
      slug: 'khasab-premium-tour',
      title: 'Khasab Premium Fjord Tour',
      description: 'Exclusive full-day Khasab tour with private boat, dolphin watching, snorkelling, cave exploration and lunch — from AED 890/adult.',
      image: 'https://images.unsplash.com/photo-1544551763-46a013bb70d5?q=80&w=800&auto=format&fit=crop',
      ctaLabel: 'Book Premium',
    },
    {
      slug: 'oman-mountain-tour',
      title: 'Oman Mountain & Wadi Tour',
      description: 'Guided off-road adventure through the Hajar mountains and ancient wadis of northern Oman — full-day from Dubai.',
      image: omanImg,
      ctaLabel: 'Book Tour',
    },
  ];
...
function getMountainAdventureItems(): ExperienceCatalogItem[] {
  ...
  return [
    ...
    },
    {
      ...
      description: 'Rocky valley with natural pools and hiking routes, Ras Al Khaimah â popular local off-road destination  Nov–Mar',
      image: mountainImg,
      ctaLabel: 'Discover',
    },
    {
...
export const DALC_EXPERIENCE_CATEGORIES: ExperienceCatalogCategory[] = [
  ...
  },
  {
    ...
    description: 'Jet skis, flyboarding, wakeboarding, scuba diving, parasailing and kayaking along the UAE coastline.',
    items: [...getWaterActivityItems(), ...getWaterExtrasItems().filter((i) => !i.slug.includes('yacht'))],
  },
  {
    slug: 'yacht-charter',
    title: 'Yacht Charter',
    description: 'Private yacht charters in Dubai — luxury cruises, party yachts, sunset cruises and fishing trips from Dubai Marina.',
  ...
  },
  {
    ...
    description: 'Dubai\'s world-class theme parks, iconic landmarks and entertainment attractions.',
    items: getEntertainmentItems(),
  },
  {
    slug: 'wellness',
    title: 'Wellness',
  ...
  {
    slug: 'abu-dhabi-tours',
    title: 'Abu Dhabi Tours',
    description: 'Curated day tours to Abu Dhabi — Grand Mosque, Ferrari World, Warner Bros. and private city tours from Dubai.',
    items: getAbuDhabiToursItems(),
  },
  {
    slug: 'oman-tours',
    title: 'Oman Day Trips',
    description: 'Guided day trips from Dubai to Oman — Musandam fjords, dolphin watching, snorkelling and mountain adventures.',
    items: getOmanToursItems(),
  },
  {
