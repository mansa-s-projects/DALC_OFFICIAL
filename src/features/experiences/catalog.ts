...
function getDesertAdventureItems(): ExperienceCatalogItem[] {
  const desertImages = [
    ...
    '/images/Aristodesert/image3.png',
    '/images/Aristodesert/image1.png',
  ];
...
function getObservationItems(): ExperienceCatalogItem[] {
  return [
    ...
    },
    {
      ...
      description: 'Crescent-shaped lake hidden deep in the Al Qudra dunes â€” rarely visited, extraordinary at sunset • Hidden Gem ðŸ”®',
      image: 'https://images.unsplash.com/photo-1509316975850-ff9c5deb0cd9?q=80&w=800&auto=format&fit=crop',
    ...
    },
    {
      ...
      description: 'Natural hot springs in the Ras Al Khaimah mountains â€” therapeutic mineral water, off the tourist trail • Hidden Gem ðŸ”®',
    ...
    },
    {
      ...
      description: 'Hidden coastal mangrove reserve with flamingos and rare birdlife near Ajman city • Hidden Gem ðŸ”® • Octâ€“Apr',
      image: 'https://images.unsplash.com/photo-1518822374967-36b15e5f36f5?q=80&w=800&auto=format&fit=crop',
      ctaLabel: 'Discover',
    },
  ];
...
function getCulturalItems(): ExperienceCatalogItem[] {
  ...
  return [
    ...
    },
    {
      ...
      description: 'The only remaining hilltop fort in the UAE â€” sweeping views over palm groves • Hidden Gem ðŸ”® • Octâ€“Apr',
      image: cultureImg,
      ctaLabel: 'Discover',
    },
    {
    ...
    },
    {
      ...
      description: 'One of the most important pre-Islamic sites in the UAE â€” ancient temple ruins, Umm Al Quwain • Hidden Gem ðŸ”®',
      image: cultureImg,
      ctaLabel: 'Discover',
    },
  ];
